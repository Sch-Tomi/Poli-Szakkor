$(document).ready(function() {
    ...
    // IDE JÖHETNEK A SAJÁT MEGOLDÁSOK!!! // <--- EZEK A KOMMENTEK ha ilyenbe írsz valamit nem fog lefutni
		...
		*/
		...
		// Sikerült?! kétlem... inkább CitromosSör lett belőle nem?!
		// De ki mondta hogy csak két szöveget lehet összefűzni? lehet többet is ... végtelent is...
		// Nincs más teendőd mint a két változó összefűzése közé berakni egy " " -t igen aposztrof szóköz aposztrof (így írunk szóközt valami közé ;)
